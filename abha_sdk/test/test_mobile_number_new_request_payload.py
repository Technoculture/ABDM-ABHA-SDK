...
class TestMobileNumberNewRequestPayload(unittest.TestCase):
    """MobileNumberNewRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileNumberNewRequestPayload:
        """Test MobileNumberNewRequestPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MobileNumberNewRequestPayload`
        """
        model = MobileNumberNewRequestPayload()
        if include_optional:
            return MobileNumberNewRequestPayload(
                new_mobile_number = '9545812125'
            )
        else:
            return MobileNumberNewRequestPayload(
        )
    ...
    def testMobileNumberNewRequestPayload(self):
        """Test MobileNumberNewRequestPayload"""

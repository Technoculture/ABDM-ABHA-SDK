...
class TestCovinTxnResponse(unittest.TestCase):
    """CovinTxnResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CovinTxnResponse:
        """Test CovinTxnResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CovinTxnResponse`
        """
        model = CovinTxnResponse()
        if include_optional:
            return CovinTxnResponse(

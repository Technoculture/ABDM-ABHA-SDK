...
class TestHidChangePasswordRequestPayload(unittest.TestCase):
    """HidChangePasswordRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidChangePasswordRequestPayload:
        """Test HidChangePasswordRequestPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HidChangePasswordRequestPayload`
        """
        model = HidChangePasswordRequestPayload()
        if include_optional:
            return HidChangePasswordRequestPayload(
                new_password = 'India@259',
                old_password = 'India@143'
            )
        else:
            return HidChangePasswordRequestPayload(
                new_password = 'India@259',
    ...
    def testHidChangePasswordRequestPayload(self):
        """Test HidChangePasswordRequestPayload"""

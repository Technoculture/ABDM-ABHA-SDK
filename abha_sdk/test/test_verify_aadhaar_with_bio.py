...
class TestVerifyAadhaarWithBio(unittest.TestCase):
    """VerifyAadhaarWithBio unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyAadhaarWithBio:
        """Test VerifyAadhaarWithBio
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyAadhaarWithBio`
        """
        model = VerifyAadhaarWithBio()
        if include_optional:
            return VerifyAadhaarWithBio(
                aadhaar = '31541756999',
                bio_type = 'FMR',
    ...
    def testVerifyAadhaarWithBio(self):
        """Test VerifyAadhaarWithBio"""

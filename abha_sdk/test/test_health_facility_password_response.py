...
class TestHealthFacilityPasswordResponse(unittest.TestCase):
    """HealthFacilityPasswordResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthFacilityPasswordResponse:
        """Test HealthFacilityPasswordResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthFacilityPasswordResponse`
        """
        model = HealthFacilityPasswordResponse()
        if include_optional:
            return HealthFacilityPasswordResponse(
                password = ''
            )
        else:
            return HealthFacilityPasswordResponse(
    ...
    def testHealthFacilityPasswordResponse(self):
        """Test HealthFacilityPasswordResponse"""

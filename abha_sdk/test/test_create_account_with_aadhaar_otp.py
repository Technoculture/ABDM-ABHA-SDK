...
class TestCreateAccountWithAadhaarOtp(unittest.TestCase):
    """CreateAccountWithAadhaarOtp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAccountWithAadhaarOtp:
        """Test CreateAccountWithAadhaarOtp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAccountWithAadhaarOtp`
        """
        model = CreateAccountWithAadhaarOtp()
        if include_optional:
            return CreateAccountWithAadhaarOtp(
    ...
    def testCreateAccountWithAadhaarOtp(self):
        """Test CreateAccountWithAadhaarOtp"""

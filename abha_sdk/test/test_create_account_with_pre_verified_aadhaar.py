...
class TestCreateAccountWithPreVerifiedAadhaar(unittest.TestCase):
    """CreateAccountWithPreVerifiedAadhaar unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAccountWithPreVerifiedAadhaar:
        """Test CreateAccountWithPreVerifiedAadhaar
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAccountWithPreVerifiedAadhaar`
        """
        model = CreateAccountWithPreVerifiedAadhaar()
        if include_optional:
            return CreateAccountWithPreVerifiedAadhaar(
    ...
    def testCreateAccountWithPreVerifiedAadhaar(self):
        """Test CreateAccountWithPreVerifiedAadhaar"""

...
class TestIdentityDocumentsByFMRequest(unittest.TestCase):
    """IdentityDocumentsByFMRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityDocumentsByFMRequest:
        """Test IdentityDocumentsByFMRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityDocumentsByFMRequest`
        """
        model = IdentityDocumentsByFMRequest()
        if include_optional:
            return IdentityDocumentsByFMRequest(
    ...
    def testIdentityDocumentsByFMRequest(self):
        """Test IdentityDocumentsByFMRequest"""

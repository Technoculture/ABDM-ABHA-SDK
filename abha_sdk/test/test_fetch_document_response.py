...
class TestFetchDocumentResponse(unittest.TestCase):
    """FetchDocumentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchDocumentResponse:
        """Test FetchDocumentResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchDocumentResponse`
        """
        model = FetchDocumentResponse()
        if include_optional:
    ...
    def testFetchDocumentResponse(self):
        """Test FetchDocumentResponse"""

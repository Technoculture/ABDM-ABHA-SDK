...
class TestHidUpdateAccountRequest(unittest.TestCase):
    """HidUpdateAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidUpdateAccountRequest:
        """Test HidUpdateAccountRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HidUpdateAccountRequest`
        """
        model = HidUpdateAccountRequest()
        if include_optional:
            return HidUpdateAccountRequest(
    ...
    def testHidUpdateAccountRequest(self):
        """Test HidUpdateAccountRequest"""

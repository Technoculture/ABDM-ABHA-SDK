...
class TestRegistrationWithAadhaarApi(unittest.TestCase):
    """RegistrationWithAadhaarApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RegistrationWithAadhaarApi()

    def tearDown(self) -> None:
        pass

    def test_create_aadhaar_account_using_post(self) -> None:
    ...
    def test_generate_aadhar_otp_using_post(self) -> None:
    ...
    def test_generate_mobile_otp_for_txn_using_post(self) -> None:
    ...
    def test_resend_aadhar_otp_using_post(self) -> None:
    ...
    def test_verify_aadhar_bio_using_post(self) -> None:
    ...
    def test_verify_aadhar_otp_only_using_post(self) -> None:
    ...
    def test_verify_mobile_otp_for_txn_using_post(self) -> None:

...
class TestRetriveHealthIdMobilePayLoad(unittest.TestCase):
    """RetriveHealthIdMobilePayLoad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetriveHealthIdMobilePayLoad:
        """Test RetriveHealthIdMobilePayLoad
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetriveHealthIdMobilePayLoad`
        """
        model = RetriveHealthIdMobilePayLoad()
        if include_optional:
            return RetriveHealthIdMobilePayLoad(
                day_of_birth = '31',
                first_name = 'Kishan',
                gender = 'M',
                last_name = 'Singh',
    ...
    def testRetriveHealthIdMobilePayLoad(self):
        """Test RetriveHealthIdMobilePayLoad"""

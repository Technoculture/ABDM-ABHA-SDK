...
class IdentityDocumentsBySelfResponse(BaseModel):
    """
    ...
    document_photo: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(default=None, description="Encoded with Base 64", alias="documentPhoto")
    document_type: Optional[StrictStr] = Field(default=None, description="Type of the document", alias="documentType")
    ...
    photo: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(default=None, description="Encoded with Base 64")
    photo_back: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(default=None, description="Encoded with Base 64", alias="photoBack")
    ...
    __properties: ClassVar[List[str]] = ["address", "authMethods", "dayOfBirth", "districtCode", "documentNumber", "documentPhoto", "documentType", "firstName", "gender", "healthId", "healthIdNumber", "lastName", "middleName", "mobile", "monthOfBirth", "name", "photo", "photoBack", "state", "stateCode", "stateName", "token", "verificationStatus", "verificationType", "yearOfBirth"]
    ...
    @field_validator('document_photo')
    def document_photo_validate_regular_expression(cls, value):
    ...
    def document_type_validate_enum(cls, value):
        ...
        if value not in set(['DRIVING_LICENCE']):
            raise ValueError("must be one of enum values ('DRIVING_LICENCE')")
        return value
    ...
    @field_validator('photo_back')
    def photo_back_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documentPhoto": obj.get("documentPhoto"),

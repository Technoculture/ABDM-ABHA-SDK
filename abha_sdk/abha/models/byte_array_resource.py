...
class ByteArrayResource(BaseModel):
    ...
    ByteArrayResource
    """ # noqa: E501
    byte_array: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(default=None, alias="byteArray")
    ...
    __properties: ClassVar[List[str]] = ["byteArray", "description", "file", "filename", "inputStream", "open", "readable", "uri", "url"]

    @field_validator('byte_array')
    def byte_array_validate_regular_expression(cls, value):

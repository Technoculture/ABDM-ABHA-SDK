...
class HidBenefitLinkedRequestPayload(BaseModel):
    ...
    uid_token: StrictStr = Field(description="JWT Bearer Token", alias="uidToken")
    validity: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["benefitId", "benefitName", "stateCode", "uidToken", "validity"]

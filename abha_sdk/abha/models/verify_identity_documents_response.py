...
class VerifyIdentityDocumentsResponse(BaseModel):
    """
    VerifyIdentityDocumentsResponse
    """ # noqa: E501
    fields: Optional[List[FieldResponse]] = None
    matched: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["fields", "matched"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [FieldResponse.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,

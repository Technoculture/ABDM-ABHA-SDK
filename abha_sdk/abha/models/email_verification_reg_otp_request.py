...
class EmailVerificationRegOTPRequest(BaseModel):
    """
    EmailVerificationRegOTPRequest
    """ # noqa: E501
    email_address: Optional[StrictStr] = Field(default=None, description="Valid Email Address of the Beneficiary.", alias="emailAddress")
    txn_id: StrictStr = Field(description="Transaction ID", alias="txnId")
    __properties: ClassVar[List[str]] = ["emailAddress", "txnId"]

...
class CreateHidNotifyBenefitRequest(BaseModel):
    ...
    """ # noqa: E501
    aadhar_number_or_uid_token: StrictStr = Field(description="JWT Bearer Token", alias="aadharNumberOrUidToken")
    ...
    __properties: ClassVar[List[str]] = ["aadharNumberOrUidToken", "autoGeneratedBenefitId", "benefitId", "benefitName", "consentHealthId", "dateOfBirth", "gender", "mobileNumber", "name", "stateCode", "validity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aadharNumberOrUidToken": obj.get("aadharNumberOrUidToken"),

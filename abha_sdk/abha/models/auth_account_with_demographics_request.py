...
class AuthAccountWithDemographicsRequest(BaseModel):
    ...
    """ # noqa: E501
    gender: Optional[Annotated[str, Field(strict=True)]] = None
    name: Optional[StrictStr] = None
    txn_id: Optional[StrictStr] = Field(default=None, alias="txnId")
    year_of_birth: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="yearOfBirth")
    __properties: ClassVar[List[str]] = ["gender", "name", "txnId", "yearOfBirth"]

...
class CreateHIdDemoAuthRequest(BaseModel):
    ...
    """ # noqa: E501
    aadhar_number: Annotated[str, Field(strict=True)] = Field(alias="aadharNumber")
    ...
    __properties: ClassVar[List[str]] = ["aadharNumber", "autoGeneratedBenefitId", "benefitId", "benefitName", "consentHealthId", "dateOfBirth", "gender", "mobileNumber", "name", "validity"]

    @field_validator('aadhar_number')
    def aadhar_number_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^(\d{12}|\d{16})*$", value):
            raise ValueError(r"must validate the regular expression /^(\d{12}|\d{16})*$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aadharNumber": obj.get("aadharNumber"),

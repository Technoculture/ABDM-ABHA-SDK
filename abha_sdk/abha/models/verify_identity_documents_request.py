...
class VerifyIdentityDocumentsRequest(BaseModel):
    """
    VerifyIdentityDocumentsRequest
    """ # noqa: E501
    day_of_birth: Optional[StrictStr] = Field(default=None, alias="dayOfBirth")
    document_number: StrictStr = Field(alias="documentNumber")
    ...
    __properties: ClassVar[List[str]] = ["dayOfBirth", "documentNumber", "documentType", "firstName", "gender", "lastName", "middleName", "monthOfBirth", "yearOfBirth"]

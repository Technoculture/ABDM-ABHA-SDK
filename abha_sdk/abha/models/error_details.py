...
class ErrorDetails(BaseModel):
    ...
    ErrorDetails
    """ # noqa: E501
    attribute: Optional[ErrorAttribute] = None
    code: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["attribute", "code", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": ErrorAttribute.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None,
            "code": obj.get("code"),

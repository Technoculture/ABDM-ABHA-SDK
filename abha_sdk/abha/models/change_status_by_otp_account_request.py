...
class ChangeStatusByOtpAccountRequest(BaseModel):
    """
    ChangeStatusByOtpAccountRequest
    """ # noqa: E501
    auth_method: StrictStr = Field(description="Based on authMethods", alias="authMethod")
    otp: Optional[StrictStr] = Field(default=None, description="Encrypted Mobile OTP.")
    password: Optional[StrictStr] = None
    reactivation_date: Optional[StrictStr] = Field(default=None, alias="reactivationDate")
    reasons: Optional[List[StrictStr]] = None
    txn_id: Optional[StrictStr] = Field(default=None, description="Based on UUID", alias="txnId")
    __properties: ClassVar[List[str]] = ["authMethod", "otp", "password", "reactivationDate", "reasons", "txnId"]

    @field_validator('auth_method')
    def auth_method_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AADHAAR_OTP', 'MOBILE_OTP', 'PASSWORD', 'DEMOGRAPHICS', 'AADHAAR_BIO']):
            raise ValueError("must be one of enum values ('AADHAAR_OTP', 'MOBILE_OTP', 'PASSWORD', 'DEMOGRAPHICS', 'AADHAAR_BIO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reactivationDate": obj.get("reactivationDate"),

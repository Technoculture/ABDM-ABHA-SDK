...
class RegistrationWithAadhaarApi:
    ...
    def generate_mobile_otp_for_txn_using_post(
        self,
        request: Annotated[GenerateMobileOTPForTxnRequest, Field(description="request")],
        accept_language: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def verify_aadhar_bio_using_post(
        self,
        verify_aadhar_otp_request: Annotated[VerifyAadhaarWithBio, Field(description="verifyAadharOtpRequest")],
        accept_language: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],

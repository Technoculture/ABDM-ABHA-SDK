...
class SearchApi:
    ...
    def search_user_by_account_using_post(
        self,
        search_request: Annotated[SearchByHealthIdRequest, Field(description="searchRequest")],
    ...
    def search_user_by_mobile_using_post(
        self,
        search_request: Annotated[SearchByMobileRequest, Field(description="searchRequest")],
        accept_language: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],

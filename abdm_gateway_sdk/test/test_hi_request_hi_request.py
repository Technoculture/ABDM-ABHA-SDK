...
class TestHIRequestHiRequest(unittest.TestCase):
    """HIRequestHiRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HIRequestHiRequest:
        """Test HIRequestHiRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HIRequestHiRequest`
        """
        model = HIRequestHiRequest()
        if include_optional:
    ...
    def testHIRequestHiRequest(self):
        """Test HIRequestHiRequest"""

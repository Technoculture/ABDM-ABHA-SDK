...
class ShareProfileRequestProfilePatient(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["healthId", "healthIdNumber", "name", "gender", "address", "yearOfBirth", "dayOfBirth", "monthOfBirth", "identifiers"]

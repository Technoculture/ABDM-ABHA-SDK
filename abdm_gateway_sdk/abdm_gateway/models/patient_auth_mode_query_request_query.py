...
class PatientAuthModeQueryRequestQuery(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "purpose", "requester"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requester": PatientAuthModeQueryRequestQueryRequester.from_dict(obj["requester"]) if obj.get("requester") is not None else None
        })
        return _obj

...
class PatientAuthNotificationAcknowledgement(BaseModel):
    ...
    acknowledgement: Optional[PatientAuthNotificationAcknowledgementAcknowledgement] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "acknowledgement": PatientAuthNotificationAcknowledgementAcknowledgement.from_dict(obj["acknowledgement"]) if obj.get("acknowledgement") is not None else None,

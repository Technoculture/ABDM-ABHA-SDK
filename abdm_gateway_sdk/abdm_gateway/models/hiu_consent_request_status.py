...
class HIUConsentRequestStatus(BaseModel):
    ...
    consent_request: Optional[HIUConsentRequestStatusConsentRequest] = Field(default=None, alias="consentRequest")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consentRequest": HIUConsentRequestStatusConsentRequest.from_dict(obj["consentRequest"]) if obj.get("consentRequest") is not None else None,

...
class PatientDemographicResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="PHR Identifier of patient at consent manager")
    name: StrictStr
    gender: PatientGender
    year_of_birth: StrictInt = Field(alias="yearOfBirth")
    address: Optional[PatientAddress] = None
    identifiers: Optional[List[Identifier]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "gender", "yearOfBirth", "address", "identifiers"]

...
class HIUHealthInformationRequestResponse(BaseModel):
    ...
    hi_request: Optional[HIUHealthInformationRequestResponseHiRequest] = Field(default=None, alias="hiRequest")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hiRequest": HIUHealthInformationRequestResponseHiRequest.from_dict(obj["hiRequest"]) if obj.get("hiRequest") is not None else None,

...
class PatientAuthConfirmRequestCredential(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["authCode", "demographic"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "demographic": PatientDemographic.from_dict(obj["demographic"]) if obj.get("demographic") is not None else None
        })
        return _obj

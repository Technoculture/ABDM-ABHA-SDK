...
class PatientAuthNotification(BaseModel):
    ...
    auth: Optional[PatientAuthNotificationAuth] = None
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "auth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auth": PatientAuthNotificationAuth.from_dict(obj["auth"]) if obj.get("auth") is not None else None
        })
        return _obj

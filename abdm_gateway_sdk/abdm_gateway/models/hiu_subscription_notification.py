...
class HIUSubscriptionNotification(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "event"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event": HIUSubscriptionNotificationEvent.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
        return _obj

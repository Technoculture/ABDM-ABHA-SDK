...
class HIUConsentNotificationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "acknowledgement", "error", "resp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in acknowledgement (list)
        _items = []
        if self.acknowledgement:
            for _item in self.acknowledgement:
                if _item:
                    _items.append(_item.to_dict())
            _dict['acknowledgement'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "acknowledgement": [ConsentAcknowledgement.from_dict(_item) for _item in obj["acknowledgement"]] if obj.get("acknowledgement") is not None else None,

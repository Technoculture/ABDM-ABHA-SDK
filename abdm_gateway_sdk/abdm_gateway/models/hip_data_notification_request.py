...
class HipDataNotificationRequest(BaseModel):
    """
    ...
    notification: HipDataNotificationRequestNotification
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "notification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notification": HipDataNotificationRequestNotification.from_dict(obj["notification"]) if obj.get("notification") is not None else None
        })
        return _obj

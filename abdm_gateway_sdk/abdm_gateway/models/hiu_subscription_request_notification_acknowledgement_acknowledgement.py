...
class HIUSubscriptionRequestNotificationAcknowledgementAcknowledgement(BaseModel):
    """
    HIUSubscriptionRequestNotificationAcknowledgementAcknowledgement
    """ # noqa: E501
    status: StrictStr
    subscription_request_id: StrictStr = Field(alias="subscriptionRequestId")
    __properties: ClassVar[List[str]] = ["status", "subscriptionRequestId"]

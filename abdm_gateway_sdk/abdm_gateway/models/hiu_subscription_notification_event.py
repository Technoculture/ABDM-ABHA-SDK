...
class HIUSubscriptionNotificationEvent(BaseModel):
    """
    HIUSubscriptionNotificationEvent
    """ # noqa: E501
    id: StrictStr
    published: datetime = Field(description="Date time format in UTC, includes miliseconds YYYY-MM-DDThh:mm:ss.vZ")
    subscription_id: StrictStr = Field(alias="subscriptionId")
    category: SubscriptionCategory
    content: HIUSubscriptionEventContent
    __properties: ClassVar[List[str]] = ["id", "published", "subscriptionId", "category", "content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": HIUSubscriptionEventContent.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj

...
class PatientAuthModeQueryResponse(BaseModel):
    ...
    auth: Optional[PatientAuthModeQueryResponseAuth] = None
    error: Optional[Error] = None
    resp: RequestReference
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "auth", "error", "resp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auth": PatientAuthModeQueryResponseAuth.from_dict(obj["auth"]) if obj.get("auth") is not None else None,

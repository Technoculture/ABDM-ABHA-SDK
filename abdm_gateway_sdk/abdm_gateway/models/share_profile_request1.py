...
class ShareProfileRequest1(BaseModel):
    """
    ...
    intent: ShareProfileRequest1Intent
    location: Location
    profile: ShareProfileRequest1Profile
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "intent", "location", "profile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intent": ShareProfileRequest1Intent.from_dict(obj["intent"]) if obj.get("intent") is not None else None,
            "location": Location.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "profile": ShareProfileRequest1Profile.from_dict(obj["profile"]) if obj.get("profile") is not None else None
        })
        return _obj

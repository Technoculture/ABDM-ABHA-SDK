...
class SubscriptionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "subscription"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscription": SubscriptionRequestSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj

...
class HIPHealthInformationRequestAcknowledgement(BaseModel):
    ...
    hi_request: Optional[HIPHealthInformationRequestAcknowledgementHiRequest] = Field(default=None, alias="hiRequest")
    error: Optional[Error] = None
    resp: RequestReference
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "hiRequest", "error", "resp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of hi_request
        if self.hi_request:
            _dict['hiRequest'] = self.hi_request.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hiRequest": HIPHealthInformationRequestAcknowledgementHiRequest.from_dict(obj["hiRequest"]) if obj.get("hiRequest") is not None else None,

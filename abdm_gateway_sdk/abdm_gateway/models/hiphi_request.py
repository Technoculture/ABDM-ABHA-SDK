...
class HIPHIRequest(BaseModel):
    ...
    hi_request: HIRequestHiRequest = Field(alias="hiRequest")
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "transactionId", "hiRequest"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hiRequest": HIRequestHiRequest.from_dict(obj["hiRequest"]) if obj.get("hiRequest") is not None else None
        })
        return _obj

...
class GatewayPatientStatusNotification(BaseModel):
    """
    ...
    resp: Optional[RequestReference] = None
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "acknowledgment", "error", "resp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of acknowledgment
        if self.acknowledgment:
            _dict['acknowledgment'] = self.acknowledgment.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "acknowledgment": PatientAuthNotificationAcknowledgementAcknowledgement.from_dict(obj["acknowledgment"]) if obj.get("acknowledgment") is not None else None,

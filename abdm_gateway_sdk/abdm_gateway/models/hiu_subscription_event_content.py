...
class HIUSubscriptionEventContent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["patient", "hip", "context"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hip": OrganizationRepresentation.from_dict(obj["hip"]) if obj.get("hip") is not None else None,
            "context": [EventCategoryDetail.from_dict(_item) for _item in obj["context"]] if obj.get("context") is not None else None
        })
        return _obj

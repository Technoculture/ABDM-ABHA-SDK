...
class SubscriptionApprovalNotificationNotification(BaseModel):
    """
    SubscriptionApprovalNotificationNotification
    """ # noqa: E501
    subscription_request_id: Optional[StrictStr] = Field(default=None, alias="subscriptionRequestId")
    status: SubscriptionStatus
    subscription: Optional[HIUSubscription] = None
    __properties: ClassVar[List[str]] = ["subscriptionRequestId", "status", "subscription"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptionRequestId": obj.get("subscriptionRequestId"),
            "status": obj.get("status"),
            "subscription": HIUSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj

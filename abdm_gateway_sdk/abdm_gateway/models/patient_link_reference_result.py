...
class PatientLinkReferenceResult(BaseModel):
    ...
    link: Optional[PatientLinkReferenceResultLink] = None
    error: Optional[Error] = None
    resp: RequestReference
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "transactionId", "link", "error", "resp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "link": PatientLinkReferenceResultLink.from_dict(obj["link"]) if obj.get("link") is not None else None,

...
class HIPHealthInformationRequestAcknowledgementHiRequest(BaseModel):
    """
    ...
    def session_status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ACKNOWLEDGED']):
            raise ValueError("must be one of enum values ('ACKNOWLEDGED')")
        return value

...
class ConsentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "consent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consent": ConsentRequestConsent.from_dict(obj["consent"]) if obj.get("consent") is not None else None
        })
        return _obj

...
class HIUSubscriptionRequestReceipt(BaseModel):
    ...
    subscription_request: Optional[ConsentRequestInitResponseConsentRequest] = Field(default=None, alias="subscriptionRequest")
    error: Optional[Error] = None
    resp: RequestReference
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "subscriptionRequest", "error", "resp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of subscription_request
        if self.subscription_request:
            _dict['subscriptionRequest'] = self.subscription_request.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptionRequest": ConsentRequestInitResponseConsentRequest.from_dict(obj["subscriptionRequest"]) if obj.get("subscriptionRequest") is not None else None,

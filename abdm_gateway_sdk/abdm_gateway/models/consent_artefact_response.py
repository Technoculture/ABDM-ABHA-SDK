...
class ConsentArtefactResponse(BaseModel):
    ...
    consent: Optional[ConsentArtefactResponseConsent] = None
    error: Optional[Error] = None
    resp: RequestReference
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "consent", "error", "resp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consent": ConsentArtefactResponseConsent.from_dict(obj["consent"]) if obj.get("consent") is not None else None,

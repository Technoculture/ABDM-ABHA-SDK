...
class ConsentRequestInitResponse(BaseModel):
    ...
    consent_request: Optional[ConsentRequestInitResponseConsentRequest] = Field(default=None, alias="consentRequest")
    error: Optional[Error] = None
    resp: RequestReference
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "consentRequest", "error", "resp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.consent_request:
            _dict['consentRequest'] = self.consent_request.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consentRequest": ConsentRequestInitResponseConsentRequest.from_dict(obj["consentRequest"]) if obj.get("consentRequest") is not None else None,

...
class PatientCareContextLink(BaseModel):
    ...
    """ # noqa: E501
    access_token: StrictStr = Field(description="AccessToken fetched in the user auth process for the purpose specified", alias="accessToken")
    patient: PatientCareContextLinkPatient
    __properties: ClassVar[List[str]] = ["accessToken", "patient"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "patient": PatientCareContextLinkPatient.from_dict(obj["patient"]) if obj.get("patient") is not None else None
        })
        return _obj

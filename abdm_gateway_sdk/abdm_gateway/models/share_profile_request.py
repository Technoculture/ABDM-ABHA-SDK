...
class ShareProfileRequest(BaseModel):
    ...
    profile: ShareProfileRequestProfile
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "profile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profile": ShareProfileRequestProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None
        })
        return _obj

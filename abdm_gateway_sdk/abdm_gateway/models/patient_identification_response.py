...
class PatientIdentificationResponse(BaseModel):
    ...
    patient: Optional[PatientIdentificationResponsePatient] = None
    error: Optional[Error] = None
    resp: RequestReference
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "patient", "error", "resp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "patient": PatientIdentificationResponsePatient.from_dict(obj["patient"]) if obj.get("patient") is not None else None,

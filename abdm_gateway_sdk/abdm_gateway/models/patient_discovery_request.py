...
class PatientDiscoveryRequest(BaseModel):
    ...
    transaction_id: StrictStr = Field(description="correlation-Id for patient discovery and subsequent care context linkage", alias="transactionId")
    patient: PatientDiscoveryRequestPatient
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "transactionId", "patient"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "patient": PatientDiscoveryRequestPatient.from_dict(obj["patient"]) if obj.get("patient") is not None else None
        })
        return _obj

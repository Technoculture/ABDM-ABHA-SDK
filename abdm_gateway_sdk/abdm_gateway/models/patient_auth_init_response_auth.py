...
class PatientAuthInitResponseAuth(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["transactionId", "mode", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mode": obj.get("mode"),
            "meta": AuthMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj

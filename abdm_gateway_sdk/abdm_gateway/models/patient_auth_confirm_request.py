...
class PatientAuthConfirmRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "transactionId", "credential"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credential": PatientAuthConfirmRequestCredential.from_dict(obj["credential"]) if obj.get("credential") is not None else None
        })
        return _obj

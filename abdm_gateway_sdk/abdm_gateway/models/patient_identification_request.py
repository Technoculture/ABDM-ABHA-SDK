...
class PatientIdentificationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "query"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": PatientIdentificationRequestQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj

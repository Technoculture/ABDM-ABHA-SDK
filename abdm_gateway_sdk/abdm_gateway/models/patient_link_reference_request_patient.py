...
class PatientLinkReferenceRequestPatient(BaseModel):
    """
    ...
    care_contexts: List[CareContext] = Field(alias="careContexts")
    __properties: ClassVar[List[str]] = ["id", "referenceNumber", "careContexts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "careContexts": [CareContext.from_dict(_item) for _item in obj["careContexts"]] if obj.get("careContexts") is not None else None
        })
        return _obj

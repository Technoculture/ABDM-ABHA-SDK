...
class LinkConfirmationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "confirmation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "confirmation": LinkConfirmationRequestConfirmation.from_dict(obj["confirmation"]) if obj.get("confirmation") is not None else None
        })
        return _obj

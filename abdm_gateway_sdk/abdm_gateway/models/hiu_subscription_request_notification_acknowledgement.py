...
class HIUSubscriptionRequestNotificationAcknowledgement(BaseModel):
    ...
    acknowledgement: Optional[HIUSubscriptionRequestNotificationAcknowledgementAcknowledgement] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "acknowledgement": HIUSubscriptionRequestNotificationAcknowledgementAcknowledgement.from_dict(obj["acknowledgement"]) if obj.get("acknowledgement") is not None else None,

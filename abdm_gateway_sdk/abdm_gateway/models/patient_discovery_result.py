...
class PatientDiscoveryResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "transactionId", "patient", "error", "resp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "patient": PatientRepresentation.from_dict(obj["patient"]) if obj.get("patient") is not None else None,

...
class PatientAuthInitRequestQuery(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="id  of the patient understood by the CM")
    purpose: PatientAuthPurpose
    auth_mode: Optional[AuthenticationMode] = Field(default=None, alias="authMode")
    requester: PatientAuthRequester
    __properties: ClassVar[List[str]] = ["id", "purpose", "authMode", "requester"]

...
class MonitoringApi:
    ...
    def v05_heartbeat_get(
        ...
        _param = self._v05_heartbeat_get_serialize(
    ...
    @validate_call
    def v05_heartbeat_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def v05_heartbeat_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _v05_heartbeat_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,

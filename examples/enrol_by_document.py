...
with abha.ApiClient(configuration) as api_client:
    ...
    try:
        # ENROL - BY DOCUMENT
        api_response = api_instance.api_v3_enrollment_enrol_by_document_post(request_id, timestamp, body=body)
        print("The response of ABHAEnrollmentApi->api_v3_enrollment_enrol_by_document_post:\n")
        pprint(api_response)

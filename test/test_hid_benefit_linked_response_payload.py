...
class TestHidBenefitLinkedResponsePayload(unittest.TestCase):
    """HidBenefitLinkedResponsePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidBenefitLinkedResponsePayload:
        """Test HidBenefitLinkedResponsePayload
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HidBenefitLinkedResponsePayload`
        """
        model = HidBenefitLinkedResponsePayload()
        if include_optional:
    ...
    def testHidBenefitLinkedResponsePayload(self):
        """Test HidBenefitLinkedResponsePayload"""

...
class TestVerifyEmailOTPRequest(unittest.TestCase):
    """VerifyEmailOTPRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyEmailOTPRequest:
        """Test VerifyEmailOTPRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VerifyEmailOTPRequest`
        """
        model = VerifyEmailOTPRequest()
        if include_optional:
            return VerifyEmailOTPRequest(
                encrypted_otp = '',
                txn_id = 'c3b0c27d-e19d-4244-b8bb-3fa19285054a'
            )
        else:
            return VerifyEmailOTPRequest(
                txn_id = 'c3b0c27d-e19d-4244-b8bb-3fa19285054a',
    ...
    def testVerifyEmailOTPRequest(self):
        """Test VerifyEmailOTPRequest"""

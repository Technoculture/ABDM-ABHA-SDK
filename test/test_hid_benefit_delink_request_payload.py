...
class TestHidBenefitDelinkRequestPayload(unittest.TestCase):
    """HidBenefitDelinkRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidBenefitDelinkRequestPayload:
        """Test HidBenefitDelinkRequestPayload
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HidBenefitDelinkRequestPayload`
        """
        model = HidBenefitDelinkRequestPayload()
        if include_optional:
            return HidBenefitDelinkRequestPayload(
    ...
    def testHidBenefitDelinkRequestPayload(self):
        """Test HidBenefitDelinkRequestPayload"""

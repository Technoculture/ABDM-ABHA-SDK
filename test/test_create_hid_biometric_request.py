...
class TestCreateHidBiometricRequest(unittest.TestCase):
    """CreateHidBiometricRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateHidBiometricRequest:
        """Test CreateHidBiometricRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateHidBiometricRequest`
        """
        model = CreateHidBiometricRequest()
        if include_optional:
            return CreateHidBiometricRequest(
                aadhaar = '31541756999',
    ...
    def testCreateHidBiometricRequest(self):
        """Test CreateHidBiometricRequest"""

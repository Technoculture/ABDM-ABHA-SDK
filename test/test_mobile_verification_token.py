...
class TestMobileVerificationToken(unittest.TestCase):
    """MobileVerificationToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileVerificationToken:
        """Test MobileVerificationToken
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MobileVerificationToken`
        """
    ...
    def testMobileVerificationToken(self):
        """Test MobileVerificationToken"""

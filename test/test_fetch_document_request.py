...
class TestFetchDocumentRequest(unittest.TestCase):
    """FetchDocumentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchDocumentRequest:
        """Test FetchDocumentRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FetchDocumentRequest`
        """
        model = FetchDocumentRequest()
        if include_optional:
    ...
    def testFetchDocumentRequest(self):
        """Test FetchDocumentRequest"""

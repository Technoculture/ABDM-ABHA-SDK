...
class TestHidUpdateMobiletRequest(unittest.TestCase):
    """HidUpdateMobiletRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidUpdateMobiletRequest:
        """Test HidUpdateMobiletRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HidUpdateMobiletRequest`
        """
        model = HidUpdateMobiletRequest()
        if include_optional:
            return HidUpdateMobiletRequest(
    ...
    def testHidUpdateMobiletRequest(self):
        """Test HidUpdateMobiletRequest"""

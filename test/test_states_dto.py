...
class TestStatesDTO(unittest.TestCase):
    """StatesDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatesDTO:
        """Test StatesDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatesDTO`
        """
        model = StatesDTO()
        if include_optional:
            return StatesDTO(
                code = '27',
                districts = [
                    abha.models.district_dto.DistrictDTO(
                        code = '490', 
                        name = 'PUNE', )
                    ],
                name = 'MAHARASHTRA'

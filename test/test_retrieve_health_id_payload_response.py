...
class TestRetrieveHealthIdPayloadResponse(unittest.TestCase):
    """RetrieveHealthIdPayloadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveHealthIdPayloadResponse:
        """Test RetrieveHealthIdPayloadResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveHealthIdPayloadResponse`
        """
        model = RetrieveHealthIdPayloadResponse()
        if include_optional:
    ...
    def testRetrieveHealthIdPayloadResponse(self):
        """Test RetrieveHealthIdPayloadResponse"""

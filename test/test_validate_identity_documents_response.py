...
class TestValidateIdentityDocumentsResponse(unittest.TestCase):
    """ValidateIdentityDocumentsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateIdentityDocumentsResponse:
        """Test ValidateIdentityDocumentsResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ValidateIdentityDocumentsResponse`
        """
        model = ValidateIdentityDocumentsResponse()
        if include_optional:
            return ValidateIdentityDocumentsResponse(
                address = 'b-14 someshwar nagar',
                enrolment_number = '43-4231-5504-6839',
                health_id_number = '43-4221-5105-6749',
                jwt_response = abha.models.jwt_response.JwtResponse(
                    expires_in = 1800, 
                    refresh_expires_in = 86400, 
                    refresh_token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c', 
                    token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c', ),
                verification = abha.models.verify_identity_documents_response.VerifyIdentityDocumentsResponse(
                    fields = [
                        abha.models.field_response.FieldResponse(
                            key = '1255477819', 
                            matched = True, )
                        ], 
                    matched = True, )
    ...
    def testValidateIdentityDocumentsResponse(self):
        """Test ValidateIdentityDocumentsResponse"""

...
class TestSearchByHealthIdRequest(unittest.TestCase):
    """SearchByHealthIdRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchByHealthIdRequest:
        """Test SearchByHealthIdRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SearchByHealthIdRequest`
        """
        model = SearchByHealthIdRequest()
        if include_optional:
            return SearchByHealthIdRequest(
    ...
    def testSearchByHealthIdRequest(self):
        """Test SearchByHealthIdRequest"""

...
class TestVerifyIdentityDocumentsRequest(unittest.TestCase):
    """VerifyIdentityDocumentsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyIdentityDocumentsRequest:
        """Test VerifyIdentityDocumentsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyIdentityDocumentsRequest`
        """
        model = VerifyIdentityDocumentsRequest()
        if include_optional:
            return VerifyIdentityDocumentsRequest(
                day_of_birth = '21',
    ...
    def testVerifyIdentityDocumentsRequest(self):
        """Test VerifyIdentityDocumentsRequest"""

...
class TestCreatePhrAdrsWithHealthIdNumReqPayLoad(unittest.TestCase):
    """CreatePhrAdrsWithHealthIdNumReqPayLoad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePhrAdrsWithHealthIdNumReqPayLoad:
        """Test CreatePhrAdrsWithHealthIdNumReqPayLoad
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreatePhrAdrsWithHealthIdNumReqPayLoad`
        """
        model = CreatePhrAdrsWithHealthIdNumReqPayLoad()
        if include_optional:
            return CreatePhrAdrsWithHealthIdNumReqPayLoad(
    ...
    def testCreatePhrAdrsWithHealthIdNumReqPayLoad(self):
        """Test CreatePhrAdrsWithHealthIdNumReqPayLoad"""

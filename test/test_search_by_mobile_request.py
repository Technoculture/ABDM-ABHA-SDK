...
class TestSearchByMobileRequest(unittest.TestCase):
    """SearchByMobileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchByMobileRequest:
        """Test SearchByMobileRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SearchByMobileRequest`
        """
        model = SearchByMobileRequest()
        if include_optional:
            return SearchByMobileRequest(
                gender = 'M',
                mobile = '9545812125',
    ...
    def testSearchByMobileRequest(self):
        """Test SearchByMobileRequest"""

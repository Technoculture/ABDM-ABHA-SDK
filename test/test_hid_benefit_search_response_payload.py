...
class TestHidBenefitSearchResponsePayload(unittest.TestCase):
    """HidBenefitSearchResponsePayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidBenefitSearchResponsePayload:
        """Test HidBenefitSearchResponsePayload
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HidBenefitSearchResponsePayload`
        """
        model = HidBenefitSearchResponsePayload()
        if include_optional:
            return HidBenefitSearchResponsePayload(
    ...
    def testHidBenefitSearchResponsePayload(self):
        """Test HidBenefitSearchResponsePayload"""

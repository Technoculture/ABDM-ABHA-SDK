...
class TestAuthWithPasswordRequest(unittest.TestCase):
    """AuthWithPasswordRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthWithPasswordRequest:
        """Test AuthWithPasswordRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AuthWithPasswordRequest`
        """
        model = AuthWithPasswordRequest()
        if include_optional:
            return AuthWithPasswordRequest(
                password = '',
                txn_id = ''
            )
        else:
    ...
    def testAuthWithPasswordRequest(self):
        """Test AuthWithPasswordRequest"""

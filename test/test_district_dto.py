...
class TestDistrictDTO(unittest.TestCase):
    """DistrictDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DistrictDTO:
        """Test DistrictDTO
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DistrictDTO`
        """
        model = DistrictDTO()
        if include_optional:
            return DistrictDTO(

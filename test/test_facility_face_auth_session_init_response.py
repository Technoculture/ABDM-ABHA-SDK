...
class TestFacilityFaceAuthSessionInitResponse(unittest.TestCase):
    """FacilityFaceAuthSessionInitResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacilityFaceAuthSessionInitResponse:
        """Test FacilityFaceAuthSessionInitResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FacilityFaceAuthSessionInitResponse`
        """
        model = FacilityFaceAuthSessionInitResponse()
        if include_optional:
            return FacilityFaceAuthSessionInitResponse(
                qrcode = '',
                suid = ''
            )
        else:
    ...
    def testFacilityFaceAuthSessionInitResponse(self):
        """Test FacilityFaceAuthSessionInitResponse"""

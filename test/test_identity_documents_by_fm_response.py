...
class TestIdentityDocumentsByFMResponse(unittest.TestCase):
    """IdentityDocumentsByFMResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityDocumentsByFMResponse:
        """Test IdentityDocumentsByFMResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `IdentityDocumentsByFMResponse`
        """
        model = IdentityDocumentsByFMResponse()
        if include_optional:
            return IdentityDocumentsByFMResponse(
                address = 'b-14 someshwar nagar',
                auth_methods = MOBILE_OTP,
                day_of_birth = '31',
                district_code = '401',
                document_number = 'DL90120170000074',
    ...
    def testIdentityDocumentsByFMResponse(self):
        """Test IdentityDocumentsByFMResponse"""

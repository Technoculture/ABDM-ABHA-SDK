...
class TestExistsbyHealthIdResponse(unittest.TestCase):
    """ExistsbyHealthIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExistsbyHealthIdResponse:
        """Test ExistsbyHealthIdResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExistsbyHealthIdResponse`
        """
        model = ExistsbyHealthIdResponse()
        if include_optional:
            return ExistsbyHealthIdResponse(
                status = 'true'
            )
        else:
            return ExistsbyHealthIdResponse(
    ...
    def testExistsbyHealthIdResponse(self):
        """Test ExistsbyHealthIdResponse"""

...
class TestAadharNumberWebOptionalRequestPayload(unittest.TestCase):
    """AadharNumberWebOptionalRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AadharNumberWebOptionalRequestPayload:
        """Test AadharNumberWebOptionalRequestPayload
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AadharNumberWebOptionalRequestPayload`
        """
        model = AadharNumberWebOptionalRequestPayload()
        if include_optional:
            return AadharNumberWebOptionalRequestPayload(
    ...
    def testAadharNumberWebOptionalRequestPayload(self):
        """Test AadharNumberWebOptionalRequestPayload"""

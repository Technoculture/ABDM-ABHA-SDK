...
class TestHealthFacilityAuthenticationResponse(unittest.TestCase):
    """HealthFacilityAuthenticationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthFacilityAuthenticationResponse:
        """Test HealthFacilityAuthenticationResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HealthFacilityAuthenticationResponse`
        """
        model = HealthFacilityAuthenticationResponse()
        if include_optional:
            return HealthFacilityAuthenticationResponse(
    ...
    def testHealthFacilityAuthenticationResponse(self):
        """Test HealthFacilityAuthenticationResponse"""

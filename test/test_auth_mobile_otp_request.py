...
class TestAuthMobileOTPRequest(unittest.TestCase):
    """AuthMobileOTPRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthMobileOTPRequest:
        """Test AuthMobileOTPRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AuthMobileOTPRequest`
        """
        model = AuthMobileOTPRequest()
        if include_optional:
            return AuthMobileOTPRequest(
                healthid = ''
            )
        else:
            return AuthMobileOTPRequest(
    ...
    def testAuthMobileOTPRequest(self):
        """Test AuthMobileOTPRequest"""

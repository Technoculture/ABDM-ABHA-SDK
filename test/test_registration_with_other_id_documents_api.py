...
class TestRegistrationWithOtherIDDocumentsApi(unittest.TestCase):
    """RegistrationWithOtherIDDocumentsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RegistrationWithOtherIDDocumentsApi()

    def tearDown(self) -> None:
        pass

    def test_create_health_id_using_post(self) -> None:
        """Test case for create_health_id_using_post

        Create ABHA Number using ID documents like Driving Licence, PAN Card
        """
        pass

    def test_generate_mobile_otp_using_post4(self) -> None:
        """Test case for generate_mobile_otp_using_post4

        Generate Mobile OTP
        """
        pass

    def test_validate_document_using_post(self) -> None:
        """Test case for validate_document_using_post
    ...
    def test_verify_mobile_otp_using_post1(self) -> None:
        """Test case for verify_mobile_otp_using_post1

...
class TestHealthFacilityRoleRequest(unittest.TestCase):
    """HealthFacilityRoleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthFacilityRoleRequest:
        """Test HealthFacilityRoleRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthFacilityRoleRequest`
        """
        model = HealthFacilityRoleRequest()
        if include_optional:
            return HealthFacilityRoleRequest(
    ...
    def testHealthFacilityRoleRequest(self):
        """Test HealthFacilityRoleRequest"""

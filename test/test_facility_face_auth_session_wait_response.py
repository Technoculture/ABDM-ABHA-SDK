...
class TestFacilityFaceAuthSessionWaitResponse(unittest.TestCase):
    """FacilityFaceAuthSessionWaitResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacilityFaceAuthSessionWaitResponse:
        """Test FacilityFaceAuthSessionWaitResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FacilityFaceAuthSessionWaitResponse`
        """
        model = FacilityFaceAuthSessionWaitResponse()
        if include_optional:
            return FacilityFaceAuthSessionWaitResponse(
                devip = '',
                phone = ''
            )
        else:
    ...
    def testFacilityFaceAuthSessionWaitResponse(self):
        """Test FacilityFaceAuthSessionWaitResponse"""

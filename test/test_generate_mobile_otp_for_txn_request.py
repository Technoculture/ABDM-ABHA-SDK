...
class TestGenerateMobileOTPForTxnRequest(unittest.TestCase):
    """GenerateMobileOTPForTxnRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateMobileOTPForTxnRequest:
        """Test GenerateMobileOTPForTxnRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateMobileOTPForTxnRequest`
        """
        model = GenerateMobileOTPForTxnRequest()
        if include_optional:
            return GenerateMobileOTPForTxnRequest(
                mobile = '9545812125',
    ...
    def testGenerateMobileOTPForTxnRequest(self):
        """Test GenerateMobileOTPForTxnRequest"""

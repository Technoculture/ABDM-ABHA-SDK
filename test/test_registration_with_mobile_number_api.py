...
class TestRegistrationWithMobileNumberApi(unittest.TestCase):
    """RegistrationWithMobileNumberApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RegistrationWithMobileNumberApi()

    def tearDown(self) -> None:
        pass

    def test_generate_mobile_otp_using_post2(self) -> None:
        """Test case for generate_mobile_otp_using_post2

        Generate Mobile OTP to start registration transaction
        """
        pass

    def test_resent_otp_using_post(self) -> None:
    ...
    def test_verify_mobile_otp_using_post(self) -> None:
    ...
    def test_verify_user_via_mobile_using_post(self) -> None:

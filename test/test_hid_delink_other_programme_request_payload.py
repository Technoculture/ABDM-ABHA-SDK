...
class TestHidDelinkOtherProgrammeRequestPayload(unittest.TestCase):
    """HidDelinkOtherProgrammeRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidDelinkOtherProgrammeRequestPayload:
        """Test HidDelinkOtherProgrammeRequestPayload
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HidDelinkOtherProgrammeRequestPayload`
        """
        model = HidDelinkOtherProgrammeRequestPayload()
        if include_optional:
            return HidDelinkOtherProgrammeRequestPayload(
    ...
    def testHidDelinkOtherProgrammeRequestPayload(self):
        """Test HidDelinkOtherProgrammeRequestPayload"""

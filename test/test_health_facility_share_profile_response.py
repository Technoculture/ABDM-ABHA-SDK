...
class TestHealthFacilityShareProfileResponse(unittest.TestCase):
    """HealthFacilityShareProfileResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthFacilityShareProfileResponse:
        """Test HealthFacilityShareProfileResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HealthFacilityShareProfileResponse`
        """
        model = HealthFacilityShareProfileResponse()
        if include_optional:
            return HealthFacilityShareProfileResponse(
                error = abha.models.error.Error(
                    code = '', 
                    message = '', ),
                status = ''
            )
    ...
    def testHealthFacilityShareProfileResponse(self):
        """Test HealthFacilityShareProfileResponse"""

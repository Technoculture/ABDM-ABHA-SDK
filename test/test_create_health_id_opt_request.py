...
class TestCreateHealthIdOptRequest(unittest.TestCase):
    """CreateHealthIdOptRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateHealthIdOptRequest:
        """Test CreateHealthIdOptRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateHealthIdOptRequest`
        """
        model = CreateHealthIdOptRequest()
        if include_optional:
            return CreateHealthIdOptRequest(
    ...
    def testCreateHealthIdOptRequest(self):
        """Test CreateHealthIdOptRequest"""

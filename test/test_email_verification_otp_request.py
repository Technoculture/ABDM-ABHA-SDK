...
class TestEmailVerificationOTPRequest(unittest.TestCase):
    """EmailVerificationOTPRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailVerificationOTPRequest:
        """Test EmailVerificationOTPRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EmailVerificationOTPRequest`
        """
        model = EmailVerificationOTPRequest()
        if include_optional:
            return EmailVerificationOTPRequest(
    ...
    def testEmailVerificationOTPRequest(self):
        """Test EmailVerificationOTPRequest"""

...
class TestFacilityFaceAuthClientConnectResponse(unittest.TestCase):
    """FacilityFaceAuthClientConnectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacilityFaceAuthClientConnectResponse:
        """Test FacilityFaceAuthClientConnectResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FacilityFaceAuthClientConnectResponse`
        """
        model = FacilityFaceAuthClientConnectResponse()
        if include_optional:
            return FacilityFaceAuthClientConnectResponse(
                rip = ''
            )
        else:
            return FacilityFaceAuthClientConnectResponse(
    ...
    def testFacilityFaceAuthClientConnectResponse(self):
        """Test FacilityFaceAuthClientConnectResponse"""

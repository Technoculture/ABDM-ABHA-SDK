...
class TestCreateHidNotifyBenefitRequest(unittest.TestCase):
    """CreateHidNotifyBenefitRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateHidNotifyBenefitRequest:
        """Test CreateHidNotifyBenefitRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateHidNotifyBenefitRequest`
        """
        model = CreateHidNotifyBenefitRequest()
        if include_optional:
            return CreateHidNotifyBenefitRequest(
                aadhar_number_or_uid_token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c',
    ...
    def testCreateHidNotifyBenefitRequest(self):
        """Test CreateHidNotifyBenefitRequest"""

...
class TestCreateHIdDemoAuthRequest(unittest.TestCase):
    """CreateHIdDemoAuthRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateHIdDemoAuthRequest:
        """Test CreateHIdDemoAuthRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateHIdDemoAuthRequest`
        """
        model = CreateHIdDemoAuthRequest()
        if include_optional:
            return CreateHIdDemoAuthRequest(
                aadhar_number = '31541756999',
    ...
    def testCreateHIdDemoAuthRequest(self):
        """Test CreateHIdDemoAuthRequest"""

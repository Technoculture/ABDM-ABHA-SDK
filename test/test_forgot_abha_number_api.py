...
class TestForgotABHANumberApi(unittest.TestCase):
    """ForgotABHANumberApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ForgotABHANumberApi()

    def tearDown(self) -> None:
        pass

    def test_generate_aadhar_otp_using_post1(self) -> None:
    ...
    def test_retrieval_health_id_by_aadhar_using_post(self) -> None:
    ...
    def test_retrieval_health_id_by_mobile_using_post(self) -> None:

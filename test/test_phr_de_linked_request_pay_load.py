...
class TestPhrDeLinkedRequestPayLoad(unittest.TestCase):
    """PhrDeLinkedRequestPayLoad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhrDeLinkedRequestPayLoad:
        """Test PhrDeLinkedRequestPayLoad
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PhrDeLinkedRequestPayLoad`
        """
        model = PhrDeLinkedRequestPayLoad()
        if include_optional:
            return PhrDeLinkedRequestPayLoad(
                phr_address = ''
            )
        else:
            return PhrDeLinkedRequestPayLoad(
    ...
    def testPhrDeLinkedRequestPayLoad(self):
        """Test PhrDeLinkedRequestPayLoad"""

...
class TestHidStatusRequestPayload(unittest.TestCase):
    """HidStatusRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidStatusRequestPayload:
        """Test HidStatusRequestPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HidStatusRequestPayload`
        """
        model = HidStatusRequestPayload()
        if include_optional:
            return HidStatusRequestPayload(
    ...
    def testHidStatusRequestPayload(self):
        """Test HidStatusRequestPayload"""

...
class TestEmailVerificationRegOTPRequest(unittest.TestCase):
    """EmailVerificationRegOTPRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailVerificationRegOTPRequest:
        """Test EmailVerificationRegOTPRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EmailVerificationRegOTPRequest`
        """
        model = EmailVerificationRegOTPRequest()
        if include_optional:
            return EmailVerificationRegOTPRequest(
    ...
    def testEmailVerificationRegOTPRequest(self):
        """Test EmailVerificationRegOTPRequest"""

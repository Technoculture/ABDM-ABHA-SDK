...
class TestBenefitDTO(unittest.TestCase):
    """BenefitDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BenefitDTO:
        """Test BenefitDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BenefitDTO`
        """
        model = BenefitDTO()
        if include_optional:
            return BenefitDTO(
                ...
                description = 'Benefit Detailed description',
                linkage_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                program_name = 'program Name',
                validity = 'Mon Dec 03 05:30:00 IST 2007'
            )
        else:
            return BenefitDTO(
        )

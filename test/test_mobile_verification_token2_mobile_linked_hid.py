...
class TestMobileVerificationToken2MobileLinkedHid(unittest.TestCase):
    """MobileVerificationToken2MobileLinkedHid unit test stubs"""
    ...
    def make_instance(
        ...
        """Test MobileVerificationToken2MobileLinkedHid
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MobileVerificationToken2MobileLinkedHid`
        """
        model = MobileVerificationToken2MobileLinkedHid()
        if include_optional:
            return MobileVerificationToken2MobileLinkedHid(
                health_id_number = '25-8180-3683-5375',
                health_id = '',
                name = 'priya',
                profile_photo = '',
                phr_address = ''
    ...
    def testMobileVerificationToken2MobileLinkedHid(self):
        """Test MobileVerificationToken2MobileLinkedHid"""

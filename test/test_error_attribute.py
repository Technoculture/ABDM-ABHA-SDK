...
class TestErrorAttribute(unittest.TestCase):
    """ErrorAttribute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorAttribute:
        """Test ErrorAttribute
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ErrorAttribute`
        """
        model = ErrorAttribute()
        if include_optional:

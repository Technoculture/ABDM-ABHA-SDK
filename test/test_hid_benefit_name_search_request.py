...
class TestHidBenefitNameSearchRequest(unittest.TestCase):
    """HidBenefitNameSearchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidBenefitNameSearchRequest:
        """Test HidBenefitNameSearchRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HidBenefitNameSearchRequest`
        """
        model = HidBenefitNameSearchRequest()
        if include_optional:
            return HidBenefitNameSearchRequest(
    ...
    def testHidBenefitNameSearchRequest(self):
        """Test HidBenefitNameSearchRequest"""

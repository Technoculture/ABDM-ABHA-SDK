...
class TestJwtRequest(unittest.TestCase):
    """JwtRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JwtRequest:
        """Test JwtRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `JwtRequest`
        """
        model = JwtRequest()
        if include_optional:
            return JwtRequest(

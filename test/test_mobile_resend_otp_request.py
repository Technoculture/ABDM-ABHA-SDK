...
class TestMobileResendOTPRequest(unittest.TestCase):
    """MobileResendOTPRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileResendOTPRequest:
        """Test MobileResendOTPRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MobileResendOTPRequest`
        """
        model = MobileResendOTPRequest()
        if include_optional:
            return MobileResendOTPRequest(
    ...
    def testMobileResendOTPRequest(self):
        """Test MobileResendOTPRequest"""

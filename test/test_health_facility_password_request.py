...
class TestHealthFacilityPasswordRequest(unittest.TestCase):
    """HealthFacilityPasswordRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthFacilityPasswordRequest:
        """Test HealthFacilityPasswordRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HealthFacilityPasswordRequest`
        """
        model = HealthFacilityPasswordRequest()
        if include_optional:
            return HealthFacilityPasswordRequest(
                hfr_uid = ''
            )
        else:
            return HealthFacilityPasswordRequest(
    ...
    def testHealthFacilityPasswordRequest(self):
        """Test HealthFacilityPasswordRequest"""

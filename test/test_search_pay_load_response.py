...
class TestSearchPayLoadResponse(unittest.TestCase):
    """SearchPayLoadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchPayLoadResponse:
        """Test SearchPayLoadResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchPayLoadResponse`
        """
        model = SearchPayLoadResponse()
        if include_optional:
            return SearchPayLoadResponse(
                phone_number = '',
                user_name = ''
            )
        else:
    ...
    def testSearchPayLoadResponse(self):
        """Test SearchPayLoadResponse"""

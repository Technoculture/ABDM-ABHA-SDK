...
class TestAuthAccountAadhaarBioRequest(unittest.TestCase):
    """AuthAccountAadhaarBioRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthAccountAadhaarBioRequest:
        """Test AuthAccountAadhaarBioRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AuthAccountAadhaarBioRequest`
        """
        model = AuthAccountAadhaarBioRequest()
        if include_optional:
            return AuthAccountAadhaarBioRequest(
                auth_type = 'FINGERSCAN',
                bio_type = 'FMR',
    ...
    def testAuthAccountAadhaarBioRequest(self):
        """Test AuthAccountAadhaarBioRequest"""

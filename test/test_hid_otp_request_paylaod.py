...
class TestHidOtpRequestPaylaod(unittest.TestCase):
    """HidOtpRequestPaylaod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidOtpRequestPaylaod:
        """Test HidOtpRequestPaylaod
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HidOtpRequestPaylaod`
        """
        model = HidOtpRequestPaylaod()
        if include_optional:
            return HidOtpRequestPaylaod(
                new_password = 'India@143',
                otp = '816405',
    ...
    def testHidOtpRequestPaylaod(self):
        """Test HidOtpRequestPaylaod"""

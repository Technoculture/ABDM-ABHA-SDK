...
class TestHidLinkedOtherProgramRequestPayload(unittest.TestCase):
    """HidLinkedOtherProgramRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidLinkedOtherProgramRequestPayload:
        """Test HidLinkedOtherProgramRequestPayload
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HidLinkedOtherProgramRequestPayload`
        """
        model = HidLinkedOtherProgramRequestPayload()
        if include_optional:
            return HidLinkedOtherProgramRequestPayload(
    ...
    def testHidLinkedOtherProgramRequestPayload(self):
        """Test HidLinkedOtherProgramRequestPayload"""

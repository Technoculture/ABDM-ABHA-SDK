...
class TestAuthWithMobileTxnAndUserData(unittest.TestCase):
    """AuthWithMobileTxnAndUserData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthWithMobileTxnAndUserData:
        """Test AuthWithMobileTxnAndUserData
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AuthWithMobileTxnAndUserData`
        """
        model = AuthWithMobileTxnAndUserData()
        if include_optional:
            return AuthWithMobileTxnAndUserData(
                gender = 'Male',
    ...
    def testAuthWithMobileTxnAndUserData(self):
        """Test AuthWithMobileTxnAndUserData"""

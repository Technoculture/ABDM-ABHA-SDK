...
class TestAuthAccountAadhaarOTPRequest(unittest.TestCase):
    """AuthAccountAadhaarOTPRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthAccountAadhaarOTPRequest:
        """Test AuthAccountAadhaarOTPRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AuthAccountAadhaarOTPRequest`
        """
        model = AuthAccountAadhaarOTPRequest()
        if include_optional:
            return AuthAccountAadhaarOTPRequest(
                otp = '816406',
    ...
    def testAuthAccountAadhaarOTPRequest(self):
        """Test AuthAccountAadhaarOTPRequest"""

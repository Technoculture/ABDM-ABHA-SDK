...
class TestAuthInitRequest(unittest.TestCase):
    """AuthInitRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthInitRequest:
        """Test AuthInitRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthInitRequest`
        """
        model = AuthInitRequest()
        if include_optional:

...
class TestPhrLinkedOrDeLinkedRequestPayLoad(unittest.TestCase):
    """PhrLinkedOrDeLinkedRequestPayLoad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhrLinkedOrDeLinkedRequestPayLoad:
        """Test PhrLinkedOrDeLinkedRequestPayLoad
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhrLinkedOrDeLinkedRequestPayLoad`
        """
        model = PhrLinkedOrDeLinkedRequestPayLoad()
        if include_optional:
            return PhrLinkedOrDeLinkedRequestPayLoad(
                phr_address = '',
                preferred = True
            )
        else:
    ...
    def testPhrLinkedOrDeLinkedRequestPayLoad(self):
        """Test PhrLinkedOrDeLinkedRequestPayLoad"""

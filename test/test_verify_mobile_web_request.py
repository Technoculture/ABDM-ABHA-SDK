...
class TestVerifyMobileWebRequest(unittest.TestCase):
    """VerifyMobileWebRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyMobileWebRequest:
        """Test VerifyMobileWebRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyMobileWebRequest`
        """
        model = VerifyMobileWebRequest()
        if include_optional:
            return VerifyMobileWebRequest(
    ...
    def testVerifyMobileWebRequest(self):
        """Test VerifyMobileWebRequest"""

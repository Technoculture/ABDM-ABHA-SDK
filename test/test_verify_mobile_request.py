...
class TestVerifyMobileRequest(unittest.TestCase):
    """VerifyMobileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyMobileRequest:
        """Test VerifyMobileRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VerifyMobileRequest`
        """
    ...
    def testVerifyMobileRequest(self):
        """Test VerifyMobileRequest"""

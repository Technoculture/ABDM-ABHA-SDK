...
class TestMobileVerificationToken2(unittest.TestCase):
    """MobileVerificationToken2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileVerificationToken2:
        """Test MobileVerificationToken2
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MobileVerificationToken2`
        """
        model = MobileVerificationToken2()
        if include_optional:
            return MobileVerificationToken2(
                txnid = '25c1b379-984c-4b56-a86f-58c386879149',
                token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c',
                mobile_linked_hid = abha.models.mobile_verification_token_2_mobile_linked_hid.MobileVerificationToken_2_mobileLinkedHid(
    ...
    def testMobileVerificationToken2(self):
        """Test MobileVerificationToken2"""

...
class TestCreateAccountByVerifiedMobileRequest(unittest.TestCase):
    """CreateAccountByVerifiedMobileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAccountByVerifiedMobileRequest:
        """Test CreateAccountByVerifiedMobileRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateAccountByVerifiedMobileRequest`
        """
        model = CreateAccountByVerifiedMobileRequest()
        if include_optional:
            return CreateAccountByVerifiedMobileRequest(
    ...
    def testCreateAccountByVerifiedMobileRequest(self):
        """Test CreateAccountByVerifiedMobileRequest"""

...
class TestAadharNumberRequestOptionalPayload(unittest.TestCase):
    """AadharNumberRequestOptionalPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AadharNumberRequestOptionalPayload:
        """Test AadharNumberRequestOptionalPayload
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AadharNumberRequestOptionalPayload`
        """
        model = AadharNumberRequestOptionalPayload()
        if include_optional:
            return AadharNumberRequestOptionalPayload(
                aadhaar = '31541756999'
            )
        else:
            return AadharNumberRequestOptionalPayload(
    ...
    def testAadharNumberRequestOptionalPayload(self):
        """Test AadharNumberRequestOptionalPayload"""

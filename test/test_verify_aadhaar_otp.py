...
class TestVerifyAadhaarOtp(unittest.TestCase):
    """VerifyAadhaarOtp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyAadhaarOtp:
        """Test VerifyAadhaarOtp
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VerifyAadhaarOtp`
        """
        model = VerifyAadhaarOtp()
        if include_optional:

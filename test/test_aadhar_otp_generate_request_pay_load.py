...
class TestAadharOtpGenerateRequestPayLoad(unittest.TestCase):
    """AadharOtpGenerateRequestPayLoad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AadharOtpGenerateRequestPayLoad:
        """Test AadharOtpGenerateRequestPayLoad
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AadharOtpGenerateRequestPayLoad`
        """
        model = AadharOtpGenerateRequestPayLoad()
        if include_optional:
            return AadharOtpGenerateRequestPayLoad(
                aadhaar = '31541756999'
            )
        else:
            return AadharOtpGenerateRequestPayLoad(
    ...
    def testAadharOtpGenerateRequestPayLoad(self):
        """Test AadharOtpGenerateRequestPayLoad"""

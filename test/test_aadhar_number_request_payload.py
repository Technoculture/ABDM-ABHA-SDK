...
class TestAadharNumberRequestPayload(unittest.TestCase):
    """AadharNumberRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AadharNumberRequestPayload:
        """Test AadharNumberRequestPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AadharNumberRequestPayload`
        """
        model = AadharNumberRequestPayload()
        if include_optional:
            return AadharNumberRequestPayload(
                aadhaar = '31541756999'
            )
        else:
            return AadharNumberRequestPayload(
    ...
    def testAadharNumberRequestPayload(self):
        """Test AadharNumberRequestPayload"""

...
class TestIdentityDocumentsBySelfResponse(unittest.TestCase):
    """IdentityDocumentsBySelfResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityDocumentsBySelfResponse:
        """Test IdentityDocumentsBySelfResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `IdentityDocumentsBySelfResponse`
        """
        model = IdentityDocumentsBySelfResponse()
        if include_optional:
            return IdentityDocumentsBySelfResponse(
                address = 'b-14 someshwar nagar',
                auth_methods = AADHAAR_OTP,
                day_of_birth = '31',
                district_code = '401',
                document_number = 'UK0720190567',
                document_photo = '',
    ...
    def testIdentityDocumentsBySelfResponse(self):
        """Test IdentityDocumentsBySelfResponse"""

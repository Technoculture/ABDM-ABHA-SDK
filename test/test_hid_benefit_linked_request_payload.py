...
class TestHidBenefitLinkedRequestPayload(unittest.TestCase):
    """HidBenefitLinkedRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidBenefitLinkedRequestPayload:
        """Test HidBenefitLinkedRequestPayload
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HidBenefitLinkedRequestPayload`
        """
        model = HidBenefitLinkedRequestPayload()
        if include_optional:
            return HidBenefitLinkedRequestPayload(
                benefit_id = 'axsp1233525903',
                benefit_name = 'Govt of AP',
                state_code = '27',
                uid_token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c',
                validity = '2007-12-03'
            )
        else:
            return HidBenefitLinkedRequestPayload(
    ...
    def testHidBenefitLinkedRequestPayload(self):
        """Test HidBenefitLinkedRequestPayload"""

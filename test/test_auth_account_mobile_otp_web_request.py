...
class TestAuthAccountMobileOtpWebRequest(unittest.TestCase):
    """AuthAccountMobileOtpWebRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthAccountMobileOtpWebRequest:
        """Test AuthAccountMobileOtpWebRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AuthAccountMobileOtpWebRequest`
        """
        model = AuthAccountMobileOtpWebRequest()
        if include_optional:
            return AuthAccountMobileOtpWebRequest(
    ...
    def testAuthAccountMobileOtpWebRequest(self):
        """Test AuthAccountMobileOtpWebRequest"""

...
class TestAuthAccountWithDemographicsRequest(unittest.TestCase):
    """AuthAccountWithDemographicsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthAccountWithDemographicsRequest:
        """Test AuthAccountWithDemographicsRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AuthAccountWithDemographicsRequest`
        """
        model = AuthAccountWithDemographicsRequest()
        if include_optional:
            return AuthAccountWithDemographicsRequest(
                gender = 'Male',
    ...
    def testAuthAccountWithDemographicsRequest(self):
        """Test AuthAccountWithDemographicsRequest"""

...
class TestVerifyIdentityDocumentsResponse(unittest.TestCase):
    """VerifyIdentityDocumentsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyIdentityDocumentsResponse:
        """Test VerifyIdentityDocumentsResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VerifyIdentityDocumentsResponse`
        """
        model = VerifyIdentityDocumentsResponse()
        if include_optional:
            return VerifyIdentityDocumentsResponse(
                fields = [
    ...
    def testVerifyIdentityDocumentsResponse(self):
        """Test VerifyIdentityDocumentsResponse"""

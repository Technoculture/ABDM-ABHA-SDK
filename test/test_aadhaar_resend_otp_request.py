...
class TestAadhaarResendOTPRequest(unittest.TestCase):
    """AadhaarResendOTPRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AadhaarResendOTPRequest:
        """Test AadhaarResendOTPRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AadhaarResendOTPRequest`
        """
        model = AadhaarResendOTPRequest()
        if include_optional:
            return AadhaarResendOTPRequest(
    ...
    def testAadhaarResendOTPRequest(self):
        """Test AadhaarResendOTPRequest"""

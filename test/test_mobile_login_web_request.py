...
class TestMobileLoginWebRequest(unittest.TestCase):
    """MobileLoginWebRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MobileLoginWebRequest:
        """Test MobileLoginWebRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MobileLoginWebRequest`
        """
        model = MobileLoginWebRequest()
        if include_optional:
            return MobileLoginWebRequest(
                health_id = '25-7840-4131-2620',
                txn_id = '25c1b379-984c-4b56-a86f-58c386879149'
            )
        else:
            return MobileLoginWebRequest(
        )
    ...
    def testMobileLoginWebRequest(self):
        """Test MobileLoginWebRequest"""

...
class TestHidBenefitRequestPayload(unittest.TestCase):
    """HidBenefitRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidBenefitRequestPayload:
        """Test HidBenefitRequestPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HidBenefitRequestPayload`
        """
        model = HidBenefitRequestPayload()
        if include_optional:
            return HidBenefitRequestPayload(
                ...
                token = abha.models.jwt_response.JwtResponse(
                    expires_in = 1800, 
    ...
    def testHidBenefitRequestPayload(self):
        """Test HidBenefitRequestPayload"""

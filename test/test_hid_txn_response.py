...
class TestHidTxnResponse(unittest.TestCase):
    """HidTxnResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HidTxnResponse:
        """Test HidTxnResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HidTxnResponse`
        """
        model = HidTxnResponse()
        if include_optional:
            return HidTxnResponse(
                mobile_number = 'XXXXXX2125',

...
class TestAuthAccountMobileOTPRequest(unittest.TestCase):
    """AuthAccountMobileOTPRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthAccountMobileOTPRequest:
        """Test AuthAccountMobileOTPRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AuthAccountMobileOTPRequest`
        """
        model = AuthAccountMobileOTPRequest()
        if include_optional:
            return AuthAccountMobileOTPRequest(
                otp = '',
                txn_id = ''
            )
        else:
    ...
    def testAuthAccountMobileOTPRequest(self):
        """Test AuthAccountMobileOTPRequest"""

...
class TestLoginWithMobileNumberApi(unittest.TestCase):
    """LoginWithMobileNumberApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LoginWithMobileNumberApi()

    def tearDown(self) -> None:
        pass

    def test_generate_mobile_otp_using_post7(self) -> None:
        """Test case for generate_mobile_otp_using_post7

        Generate Mobile OTP to start registration transaction
        """
        pass

    def test_get_hid_info_using_post(self) -> None:
        """Test case for get_hid_info_using_post

        Create ABHA Number with verified mobile token
        """
        pass

    def test_resent_otp_using_post2(self) -> None:
        """Test case for resent_otp_using_post2

        Resend Mobile OTP in an existing transaction in case previous OTP is not received.
        """
        pass

    def test_verify_mobile_otp_using_post2(self) -> None:
        """Test case for verify_mobile_otp_using_post2

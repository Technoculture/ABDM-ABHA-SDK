...
class TestHealthFacilityChangedPasswordRequest(unittest.TestCase):
    """HealthFacilityChangedPasswordRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthFacilityChangedPasswordRequest:
        """Test HealthFacilityChangedPasswordRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HealthFacilityChangedPasswordRequest`
        """
        model = HealthFacilityChangedPasswordRequest()
        if include_optional:
            return HealthFacilityChangedPasswordRequest(
                hfr_uid = 'IN0510000183',
                new_password = 'NewAbcdefgh@124',
                old_password = 'Abcdefgh@124'
            )
        else:
            return HealthFacilityChangedPasswordRequest(
        )
    ...
    def testHealthFacilityChangedPasswordRequest(self):
        """Test HealthFacilityChangedPasswordRequest"""

...
class TestLinkToken1RequestOneOf3(unittest.TestCase):
    """LinkToken1RequestOneOf3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkToken1RequestOneOf3:
        """Test LinkToken1RequestOneOf3
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkToken1RequestOneOf3`
        """
        model = LinkToken1RequestOneOf3()
        if include_optional:
            return LinkToken1RequestOneOf3(
    ...
    def testLinkToken1RequestOneOf3(self):
        """Test LinkToken1RequestOneOf3"""

...
class AuthAccountAadhaarBioRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["authType", "bioType", "pid", "txnId"]
    ...
    def auth_type_validate_enum(cls, value):
        ...
        if value not in set(["FINGERSCAN", "IRIS", "OTP"]):
            raise ValueError("must be one of enum values ('FINGERSCAN', 'IRIS', 'OTP')")
        return value

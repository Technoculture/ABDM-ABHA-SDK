...
class CreateHealthIdWithPreVerified200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["authMethods", "dayOfBirth", "districtCode", "districtName", "email", "firstName", "gender", "healthId", "healthIdNumber", "kycPhoto", "lastName", "middleName", "mobile", "monthOfBirth", "name", "new", "profilePhoto", "refreshToken", "stateCode", "stateName", "tags", "token", "yearOfBirth"]

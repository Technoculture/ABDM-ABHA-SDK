...
class LinkToken1RequestOneOf2(BaseModel):
    """
    LinkToken1RequestOneOf2
    """ # noqa: E501
    error: LinkToken1RequestOneOf2Error
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": LinkToken1RequestOneOf2Error.from_dict(obj["error"]) if obj.get("error") is not None else None,

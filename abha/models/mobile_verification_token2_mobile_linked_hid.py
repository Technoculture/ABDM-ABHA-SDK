...
class MobileVerificationToken2MobileLinkedHid(BaseModel):
    """
    ...
    profile_photo: Optional[StrictStr] = Field(default=None, alias="profilePhoto")
    phr_address: Optional[StrictStr] = Field(default=None, alias="phrAddress")
    __properties: ClassVar[List[str]] = ["healthIdNumber", "healthId", "name", "profilePhoto", "phrAddress"]

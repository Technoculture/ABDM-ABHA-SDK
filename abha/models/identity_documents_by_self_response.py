...
class IdentityDocumentsBySelfResponse(BaseModel):
    ...
    ] = Field(default=None, description="Encoded with Base 64", alias="documentPhoto")
    document_type: Optional[StrictStr] = Field(
        default=None, description="Type of the document", alias="documentType"
    )
    ...
    photo: Optional[
        Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]
    ] = Field(default=None, description="Encoded with Base 64")
    photo_back: Optional[
        Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]
    ] = Field(default=None, description="Encoded with Base 64", alias="photoBack")

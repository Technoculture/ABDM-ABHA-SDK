...
class GetAccountInformationUsingGET200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "authMethods", "dayOfBirth", "districtCode", "districtName", "email", "emailVerified", "firstName", "gender", "healthId", "healthIdNumber", "kycPhoto", "kycVerified", "lastName", "middleName", "mobile", "monthOfBirth", "name", "new", "phrAddress", "pincode", "profilePhoto", "stateCode", "stateName", "subDistrictCode", "subdistrictName", "tags", "townCode", "townName", "verificationStatus", "verificationType", "villageCode", "villageName", "wardCode", "wardName", "yearOfBirth"]

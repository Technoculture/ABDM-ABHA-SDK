...
class URI(BaseModel):
    ...
    raw_scheme_specific_part: Optional[StrictStr] = Field(
        default=None, alias="rawSchemeSpecificPart"
    )
    raw_user_info: Optional[StrictStr] = Field(default=None, alias="rawUserInfo")
    scheme: Optional[StrictStr] = None
    scheme_specific_part: Optional[StrictStr] = Field(
        default=None, alias="schemeSpecificPart"
    )

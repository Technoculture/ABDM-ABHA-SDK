        ...
        _obj = cls.model_validate(
            {
                ...
                "absoluteFile": File.from_dict(obj["absoluteFile"])
                if obj.get("absoluteFile") is not None
                else None,
                "absolutePath": obj.get("absolutePath"),
                "canonicalFile": File.from_dict(obj["canonicalFile"])
                if obj.get("canonicalFile") is not None
                else None,
                ...
                "parentFile": File.from_dict(obj["parentFile"])
                if obj.get("parentFile") is not None
                else None,
                "path": obj.get("path"),

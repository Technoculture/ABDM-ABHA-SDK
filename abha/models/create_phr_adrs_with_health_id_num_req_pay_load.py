...
class CreatePhrAdrsWithHealthIdNumReqPayLoad(BaseModel):
    """
    CreatePhrAdrsWithHealthIdNumReqPayLoad
    """  # noqa: E501

    health_id_number: StrictStr = Field(alias="healthIdNumber")
    __properties: ClassVar[List[str]] = ["healthIdNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"healthIdNumber": obj.get("healthIdNumber")})
        return _obj

...
class LinkToken1RequestOneOf1(BaseModel):
    """
    LinkToken1RequestOneOf1
    """ # noqa: E501
    error: LinkToken1RequestOneOf1Error
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": LinkToken1RequestOneOf1Error.from_dict(obj["error"]) if obj.get("error") is not None else None,

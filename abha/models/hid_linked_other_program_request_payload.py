...
class HidLinkedOtherProgramRequestPayload(BaseModel):
    """
    HidLinkedOtherProgramRequestPayload
    """ # noqa: E501
    benefit_id: StrictStr = Field(alias="benefitId")
    benefit_name: StrictStr = Field(alias="benefitName")
    state_code: Optional[StrictStr] = Field(default=None, alias="stateCode")
    user_token: StrictStr = Field(description="JWT Bearer Token", alias="userToken")
    validity: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["benefitId", "benefitName", "stateCode", "userToken", "validity"]

...
class HealthFacilityRoleRequest(BaseModel):
    """
    HealthFacilityRoleRequest
    """  # noqa: E501

    hfr_uid: Optional[StrictStr] = Field(default=None, alias="hfrUid")
    role: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["hfrUid", "role"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"hfrUid": obj.get("hfrUid"), "role": obj.get("role")}
        )
        return _obj

...
class MobileNumberNewRequestPayload(BaseModel):
    """
    MobileNumberNewRequestPayload
    """  # noqa: E501

    new_mobile_number: Optional[StrictStr] = Field(
        default=None, description="New Mobile Number.", alias="newMobileNumber"
    )
    __properties: ClassVar[List[str]] = ["newMobileNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"newMobileNumber": obj.get("newMobileNumber")})
        return _obj

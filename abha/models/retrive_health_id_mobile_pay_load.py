...
class RetriveHealthIdMobilePayLoad(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dayOfBirth", "firstName", "gender", "lastName", "middleName", "monthOfBirth", "name", "otp", "status", "txnId", "yearOfBirth"]
    ...
    def month_of_birth_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(0?[1-9]|1[012])$", value):
            raise ValueError(r"must validate the regular expression /^(0?[1-9]|1[012])$/")
        return value

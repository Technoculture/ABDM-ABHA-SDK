...
class CreateHidBiometricRequest(BaseModel):
    ...
    """ # noqa: E501
    aadhaar: Annotated[str, Field(strict=True)]
    ...
    bio_type: Optional[StrictStr] = Field(default=None, alias="bioType")
    ...
    __properties: ClassVar[List[str]] = ["aadhaar", "autoGeneratedBenefitId", "benefitId", "benefitName", "bioType", "consentHealthId", "mobileNumber", "pid", "validity"]

    @field_validator('aadhaar')
    def aadhaar_validate_regular_expression(cls, value):

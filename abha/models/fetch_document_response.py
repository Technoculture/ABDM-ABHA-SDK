...
class FetchDocumentResponse(BaseModel):
    ...
    permanent_address: Optional[StrictStr] = Field(default=None, alias="permanentAddress")
    temp_address: Optional[StrictStr] = Field(default=None, alias="tempAddress")
    year: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["day", "dob", "documentNumber", "documentType", "firstName", "gender", "lastName", "middleName", "month", "permanentAddress", "tempAddress", "year"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "month": obj.get("month"),
            "permanentAddress": obj.get("permanentAddress"),
            "tempAddress": obj.get("tempAddress"),
            "year": obj.get("year")
        })
        return _obj

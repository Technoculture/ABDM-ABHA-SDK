...
class MobileVerificationToken2(BaseModel):
    ...
    mobile_linked_hid: Optional[MobileVerificationToken2MobileLinkedHid] = Field(default=None, alias="mobileLinkedHid")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "txnid": obj.get("txnid"),
            "token": obj.get("token"),
            "mobileLinkedHid": MobileVerificationToken2MobileLinkedHid.from_dict(obj["mobileLinkedHid"]) if obj.get("mobileLinkedHid") is not None else None
        })
        return _obj

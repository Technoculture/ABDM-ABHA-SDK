...
class VerifyEmailOTPRequest(BaseModel):
    ...
    """ # noqa: E501
    encrypted_otp: Optional[StrictStr] = Field(default=None, description="OTP recevied over the Email. OTP in the encrypted form.", alias="encryptedOtp")
    txn_id: StrictStr = Field(description="Transaction ID", alias="txnId")
    __properties: ClassVar[List[str]] = ["encryptedOtp", "txnId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "encryptedOtp": obj.get("encryptedOtp"),
            "txnId": obj.get("txnId")
        })
        return _obj

...
class GeneratePngCardUsingGET200Response(BaseModel):
    """
    GeneratePngCardUsingGET200Response
    """ # noqa: E501
    byte_array: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, alias="byteArray")
    description: Optional[StrictStr] = None
    filename: Optional[StrictStr] = None
    open: Optional[StrictBool] = None
    readable: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["byteArray", "description", "filename", "open", "readable"]

...
class FacilityFaceAuthClientConnectResponse(BaseModel):
    """
    FacilityFaceAuthClientConnectResponse
    """  # noqa: E501

    rip: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["rip"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"rip": obj.get("rip")})
        return _obj

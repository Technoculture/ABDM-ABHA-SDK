...
class SearchResponseSingle(BaseModel):
    ...
    """ # noqa: E501
    auth_methods: Optional[List[StrictStr]] = Field(default=None, alias="authMethods")
    ...
    __properties: ClassVar[List[str]] = ["authMethods", "healthId", "healthIdNumber", "name", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['ACTIVE', 'BLOCKED', 'LOCKED', 'CONSENTPENDING', 'DEACTIVATED', 'DELETED']):
            raise ValueError("must be one of enum values ('ACTIVE', 'BLOCKED', 'LOCKED', 'CONSENTPENDING', 'DEACTIVATED', 'DELETED')")
        return value

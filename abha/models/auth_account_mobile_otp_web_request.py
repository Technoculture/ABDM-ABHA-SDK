...
class AuthAccountMobileOtpWebRequest(BaseModel):
    """
    AuthAccountMobileOtpWebRequest
    """  # noqa: E501

    otp: StrictStr = Field(description="Encrypted Mobile OTP.")
    txn_id: StrictStr = Field(description="Based on UUID", alias="txnId")
    __properties: ClassVar[List[str]] = ["otp", "txnId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"otp": obj.get("otp"), "txnId": obj.get("txnId")})
        return _obj

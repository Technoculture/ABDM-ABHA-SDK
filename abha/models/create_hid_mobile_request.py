...
class CreateHidMobileRequest(BaseModel):
    ...
    auto_generated_benefit_id: Optional[StrictBool] = Field(
        default=None, alias="autoGeneratedBenefitId"
    )
    ...
    consent_health_id: Optional[StrictBool] = Field(
        default=None, alias="consentHealthId"
    )
    ...
    uploaded_doc: StrictStr = Field(
        description="Encoded with Base 64", alias="uploadedDoc"
    )
    ...
    def benefit_doc_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('VOTER_ID_CARD', 'RATION_CARD', 'PAN_CARD', 'DRIVING_LICENSE', 'PENSIONER_PHOTO_CARD', 'KISSAN_PHOTO_PASSBOOK', 'FREEDOM_FIGHTER_PHOTO_CARD', 'CERTIFICATE_IDENTIFY', 'DISABILITY_ID_CARD', 'MNREGA_JOB_CARD', 'BIRTH_CERTIFICATE', 'MARRIAGE_CERTIFICATE', 'OTHER_GOVERNMENT_ID', 'ADOPTION_CERTIFICATE')"
            )
        return value

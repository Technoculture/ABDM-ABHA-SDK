...
class LinkToken1RequestOneOf3(BaseModel):
    """
    LinkToken1RequestOneOf3
    """ # noqa: E501
    error: LinkToken1RequestOneOf3Error
    response: Optional[ProfileShare2RequestOneOfResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": LinkToken1RequestOneOf3Error.from_dict(obj["error"]) if obj.get("error") is not None else None,

...
class UpdateAccountRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "dayOfBirth", "districtCode", "email", "firstName", "healthId", "lastName", "middleName", "monthOfBirth", "password", "pincode", "profilePhoto", "stateCode", "subdistrictCode", "townCode", "villageCode", "wardCode", "yearOfBirth"]

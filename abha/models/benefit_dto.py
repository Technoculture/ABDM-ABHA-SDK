...
class BenefitDTO(BaseModel):
    ...
    benefit_name: Optional[StrictStr] = Field(default=None, alias="benefitName")
    description: Optional[StrictStr] = None
    linkage_date: Optional[datetime] = Field(default=None, alias="linkageDate")
    program_name: Optional[StrictStr] = Field(default=None, alias="programName")
    validity: Optional[date] = None
    __properties: ClassVar[List[str]] = ["benefitId", "benefitName", "description", "linkageDate", "programName", "validity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "linkageDate": obj.get("linkageDate"),

...
class PhrLinkedOrDeLinkedRequestPayLoad(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["phrAddress", "preferred"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"phrAddress": obj.get("phrAddress"), "preferred": obj.get("preferred")}
        )
        return _obj

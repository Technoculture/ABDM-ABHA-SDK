...
class IdentityDocumentsBySelfRequest(BaseModel):
    """
    IdentityDocumentsBySelfRequest
    """ # noqa: E501
    address: Optional[StrictStr] = None
    day_of_birth: Optional[StrictStr] = Field(default=None, alias="dayOfBirth")
    district_code: StrictStr = Field(alias="districtCode")
    document_number: StrictStr = Field(description="The number of the document", alias="documentNumber")
    document_type: StrictStr = Field(description="Type of the document", alias="documentType")
    ...
    state_code: StrictStr = Field(alias="stateCode")
    txn_id: StrictStr = Field(description="Based on UUID", alias="txnId")
    year_of_birth: StrictStr = Field(alias="yearOfBirth")
    __properties: ClassVar[List[str]] = ["address", "dayOfBirth", "districtCode", "documentNumber", "documentType", "firstName", "gender", "lastName", "middleName", "mobile", "monthOfBirth", "photo", "photoBack", "stateCode", "txnId", "yearOfBirth"]

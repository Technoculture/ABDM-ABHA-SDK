...
class IdentityDocumentsBySelfRequest(BaseModel):
    ...
    document_number: StrictStr = Field(
        description="The number of the document", alias="documentNumber"
    )
    document_type: StrictStr = Field(
        description="Type of the document", alias="documentType"
    )

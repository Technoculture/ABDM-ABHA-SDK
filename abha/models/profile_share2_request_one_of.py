...
class ProfileShare2RequestOneOf(BaseModel):
    """
    ProfileShare2RequestOneOf
    """ # noqa: E501
    acknowledgement: Optional[ProfileShare2RequestOneOfAcknowledgement] = None
    response: ProfileShare2RequestOneOfResponse
    __properties: ClassVar[List[str]] = ["acknowledgement", "response"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "acknowledgement": ProfileShare2RequestOneOfAcknowledgement.from_dict(obj["acknowledgement"]) if obj.get("acknowledgement") is not None else None,

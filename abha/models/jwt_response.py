...
class JwtResponse(BaseModel):
    ...
    expires_in: Optional[StrictInt] = Field(
        default=None, description="Access Token expiry time", alias="expiresIn"
    )
    refresh_expires_in: Optional[StrictInt] = Field(
        default=None, description="Refresh Token expiry time", alias="refreshExpiresIn"
    )
    refresh_token: Optional[StrictStr] = Field(
        default=None, description="JWT Bearer Token", alias="refreshToken"
    )

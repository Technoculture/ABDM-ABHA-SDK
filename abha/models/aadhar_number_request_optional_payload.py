...
class AadharNumberRequestOptionalPayload(BaseModel):
    """
    AadharNumberRequestOptionalPayload
    """  # noqa: E501

    aadhaar: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"aadhaar": obj.get("aadhaar")})
        return _obj

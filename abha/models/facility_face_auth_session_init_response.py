...
class FacilityFaceAuthSessionInitResponse(BaseModel):
    """
    FacilityFaceAuthSessionInitResponse
    """  # noqa: E501

    qrcode: Optional[StrictStr] = None
    suid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["qrcode", "suid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"qrcode": obj.get("qrcode"), "suid": obj.get("suid")}
        )
        return _obj

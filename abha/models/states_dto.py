...
class StatesDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "districts", "name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in districts (list)
        _items = []
        if self.districts:
            for _item in self.districts:
                if _item:
                    _items.append(_item.to_dict())
            _dict['districts'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "districts": [DistrictDTO.from_dict(_item) for _item in obj["districts"]] if obj.get("districts") is not None else None,
            "name": obj.get("name")
        })
        return _obj

...
class FacilityFaceAuthSessionWaitResponse(BaseModel):
    """
    FacilityFaceAuthSessionWaitResponse
    """  # noqa: E501

    devip: Optional[StrictStr] = None
    phone: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["devip", "phone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"devip": obj.get("devip"), "phone": obj.get("phone")}
        )
        return _obj

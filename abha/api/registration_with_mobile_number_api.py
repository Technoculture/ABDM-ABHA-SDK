...
from abha.models.create_account_by_verified_mobile_request import (
...
class RegistrationWithMobileNumberApi:
    ...
    def generate_mobile_otp_using_post2(
        ...
        """  # noqa: E501
        warnings.warn(
            "POST /v1/registration/mobile/generateOtp is deprecated.",
            DeprecationWarning,
        )
    ...
    def resent_otp_using_post(
        self,
        resend_request: Annotated[
            MobileResendOTPRequest, Field(description="resendRequest")
        ],
        accept_language: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        """  # noqa: E501
        warnings.warn(
            "POST /v1/registration/mobile/resendOtp is deprecated.", DeprecationWarning
        )
    ...
    def verify_mobile_otp_using_post(
        self,
        verify_otp_request: Annotated[
            VerifyMobileRequest, Field(description="verifyOtpRequest")
        ],
        accept_language: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        """  # noqa: E501
        warnings.warn(
            "POST /v1/registration/mobile/verifyOtp is deprecated.", DeprecationWarning
        )
    ...
    def verify_user_via_mobile_using_post(
        ...
        create_account_request: Annotated[
            CreateAccountByVerifiedMobileRequest,
            Field(description="createAccountRequest"),
        ],
        accept_language: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        """  # noqa: E501
        warnings.warn(
            "POST /v1/registration/mobile/createHealthId is deprecated.",
            DeprecationWarning,
        )

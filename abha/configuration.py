...
conf = abha.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://healthidsbx.abdm.gov.in/api" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("abha")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "//healthidsbx.abdm.gov.in/api",
